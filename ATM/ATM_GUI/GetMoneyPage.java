...
public class GetMoneyPage extends BackJPanel {
	...
	public GetMoneyPage(CardPage cardPage) {
		...
		getMoney.setFont(new Font("微软雅黑", Font.PLAIN, 20));
		getMoney.setBounds(220, 70, 234, 50);
